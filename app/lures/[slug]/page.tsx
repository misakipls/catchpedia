...
export default function LureArticlePage({ params }: PageProps) {
  const { slug } = params
          ...
          <div className="content-area">
            <div className="content-container">
              <div className="wikipedia-page article-page">
                <Breadcrumb items={generateBreadcrumbs(`/lures/${slug}`, article?.title)} />
                <div className="page-header">
                  <Link href="/lures" className="back-button">
                    <i className="fas fa-arrow-left"></i> Back to Lures
                  </Link>
                </div>
