...
export default function ReelArticlePage({ params }: PageProps) {
  const { slug } = params
          ...
          <div className="content-area">
            <div className="content-container">
              <div className="wikipedia-page article-page">
                <Breadcrumb items={generateBreadcrumbs(`/reels/${slug}`, article?.title)} />
                <div className="page-header">
                  <Link href="/reels" className="back-button">
                    <i className="fas fa-arrow-left"></i> Back to Reels
                  </Link>
                </div>
