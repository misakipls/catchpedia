...
export default function EditArticleClient({ articleId }: EditArticleClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedArticle = editArticle(articleId, {
            ...
            <div className="content-area">
              <div className="content-container">
                <div className="error-state">
                  ...
                  <Link href="/admin/manage" className="admin-link">
    ...
    <div className="min-h-screen">
      ...
      <main className="main-content">
        <div className="page-layout">
          ...
          <div className="content-area">
            <div className="content-container">
              <Breadcrumb items={generateBreadcrumbs(`/admin/edit/${articleId}`, article?.title)} />
