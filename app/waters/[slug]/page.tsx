...
export default function WaterArticlePage({ params }: PageProps) {
  const { slug } = params
          ...
          <div className="content-area">
            <div className="content-container">
              <div className="wikipedia-page article-page">
                <Breadcrumb items={generateBreadcrumbs(`/waters/${slug}`, article?.title)} />
                <div className="page-header">
                  <Link href="/waters" className="back-button">
                    <i className="fas fa-arrow-left"></i> Back to Waters
                  </Link>
                </div>
