...
export default function KnotArticlePage({ params }: PageProps) {
  const { slug } = params
          ...
          <div className="content-area">
            <div className="content-container">
              <div className="wikipedia-page article-page">
                <Breadcrumb items={generateBreadcrumbs(`/knots/${slug}`, article?.title)} />
                <div className="page-header">
                  <Link href="/knots" className="back-button">
                    <i className="fas fa-arrow-left"></i> Back to Knots
                  </Link>
                </div>
