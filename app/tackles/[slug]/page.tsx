...
export default function TackleArticlePage({ params }: PageProps) {
  const { slug } = params
          ...
          <div className="content-area">
            <div className="content-container">
              <div className="wikipedia-page article-page">
                <Breadcrumb items={generateBreadcrumbs(`/tackles/${slug}`, article?.title)} />
                <div className="page-header">
                  <Link href="/tackles" className="back-button">
                    <i className="fas fa-arrow-left"></i> Back to Tackles
                  </Link>
                </div>
