...
export default function FishArticlePage({ params }: PageProps) {
  const { slug } = params
          ...
          <div className="content-area">
            <div className="content-container">
              <div className="wikipedia-page article-page">
                <Breadcrumb items={generateBreadcrumbs(`/fish/${slug}`, article?.title)} />
                <div className="page-header">
                  <Link href="/fish" className="back-button">
                    <i className="fas fa-arrow-left"></i> Back to Fish
                  </Link>
                </div>
