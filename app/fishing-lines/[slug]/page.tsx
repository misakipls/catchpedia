...
export default function FishingLineArticlePage({ params }: PageProps) {
  const { slug } = params
          ...
          <div className="content-area">
            <div className="content-container">
              <div className="wikipedia-page article-page">
                <Breadcrumb items={generateBreadcrumbs(`/fishing-lines/${slug}`, article?.title)} />
                <div className="page-header">
                  <Link href="/fishing-lines" className="back-button">
                    <i className="fas fa-arrow-left"></i> Back to Fishing Lines
                  </Link>
                </div>
